            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="datatable-server" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>skala/store" method="POST">
                <!-- begin:: id -->
                <input type="hidden" id="<?= $this->security->get_csrf_token_name() ?>" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
                <input type="hidden" name="id_skala" id="id_skala" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="batas_bawah" id="batas_bawah" placeholder="Masukkan batas bawah" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Batas Tengah</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="batas_tengah" id="batas_tengah" placeholder="Masukkan batas tengah" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Batas Atas</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="batas_atas" id="batas_atas" placeholder="Masukkan batas atas" />
                        </div>
                    </div>
                </div>
